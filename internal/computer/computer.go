...
// osascript runs one AppleScript snippet and returns stdout.
// Unlike mack's run(), this preserves newlines (multi-line results like tab
// lists stay readable) and does not swallow non-cancel errors.
