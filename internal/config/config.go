...
type Provider struct {
	...
	API       string `json:"api"`              // "openai-completions", "openai-codex-responses", or "anthropic-messages"
	Auth      string `json:"auth,omitempty"`   // "codex" or "claude" reuses a local subscription OAuth login
